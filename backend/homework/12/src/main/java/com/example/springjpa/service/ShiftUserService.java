...
import com.example.springjpa.interfaces.ShiftUserRepository;
...
public class ShiftUserService {
     ...
     * @throws CustomException If an error occurs during the shift user saving process.
     */
    @Transactional
    public void saveShiftUser(ShiftUser shiftUser) {
        try {
            ...
            throw new CustomException("Failed to save shift user.");
        }
    }
