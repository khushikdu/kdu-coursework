...
export function Body() {
  ...
  return (
    <div className="todo-section">
      ...
      <button className="add-btn" data-testid="add-btn" onClick={handleAddItemClick}>
        Submit
      </button>

      <button className="clear-todo add-btn" data-testid="clear-btn" onClick={handleClearBtn}>
        Clear Todo
      </button>
